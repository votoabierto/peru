  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-[#111111] mb-4">Partidos que presentan listas</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {partyList.map((party) => (
              <div key={party.id} className="card flex items-center gap-3">
                ...
                <a
                  href={`https://votoinformado.jne.gob.pe/voto/candidato-lista-parlamento-andino?org=${encodeURIComponent(party.name)}`}
                  target="_blank"
